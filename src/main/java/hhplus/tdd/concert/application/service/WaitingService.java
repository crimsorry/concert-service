...
public class WaitingService {
    ...
    /* 유저 대기열 생성 */
    public QueueTokenDto enqueueMember(long memberId){
        ...
        Waiting waiting = Waiting.generateOrReturnQueueToken(existWaiting, member);
        waitingRepository.save(waiting);
        return new QueueTokenDto(waiting.getToken());
    }

    /* 유저 대기열 조회 */
    public QueueNumDto loadWaiting(String queueToken){
