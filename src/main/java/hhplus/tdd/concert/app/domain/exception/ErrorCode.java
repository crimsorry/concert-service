...
public enum ErrorCode {
    ...
    NOT_FOUNT_MEMBER("E100", "존재하지 않는 사용자입니다."),
    NOT_FOUND_WAITING_MEMBER("E101", "사용자 확인 불가. 대기열 토큰을 발급받아 주세요."),
